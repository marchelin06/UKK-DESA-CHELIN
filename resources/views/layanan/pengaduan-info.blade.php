...
<div style="padding: 40px 20px;">
    <div style="max-width: 800px; margin: 0 auto;">
        ...
        {{-- Content --}}
        <div style="background: white; border-radius: 16px; padding: 36px; box-shadow: 0 6px 16px rgba(0,0,0,0.08); margin-bottom: 30px;">
        ...
        {{-- CTA Box --}}
        @guest
        <div style="background: linear-gradient(135deg, #e8f5e9 0%, #f1f8f5 100%); border-left: 4px solid #1b5e20; border-radius: 10px; padding: 28px; text-align: center;">
