        ...
        <div class="page-surat-layout">
                ...
                <form action="{{ route('surat.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_surat" id="jenis_surat" class="form-select" required>
                            ...
                            <option value="Surat Domisili" {{ old('jenis_surat') == 'Surat Domisili' ? 'selected' : '' }}>
                                Surat Domisili</option>
                            <option value="Surat Keterangan Tidak Mampu"
                                {{ old('jenis_surat') == 'Surat Keterangan Tidak Mampu' ? 'selected' : '' }}>Surat
                                Keterangan
                                Tidak Mampu (SKTM)</option>
                            <option value="Surat Pengantar KTP"
                                {{ old('jenis_surat') == 'Surat Pengantar KTP' ? 'selected' : '' }}>Surat Pengantar KTP
                            </option>
                            <option value="Surat Kelahiran" {{ old('jenis_surat') == 'Surat Kelahiran' ? 'selected' : '' }}>
                                Surat Kelahiran</option>
                            <option value="Surat Kematian" {{ old('jenis_surat') == 'Surat Kematian' ? 'selected' : '' }}>
                                Surat Kematian</option>
                            <option value="Surat Pengantar KUA"
                                {{ old('jenis_surat') == 'Surat Pengantar KUA' ? 'selected' : '' }}>Surat Pengantar KUA
                            </option>
                            ...
                            <option value="Surat Keterangan Tanah"
                                {{ old('jenis_surat') == 'Surat Keterangan Tanah' ? 'selected' : '' }}>Surat Keterangan
                                Tanah
                            </option>
                            <option value="Surat Undangan Rapat"
                                {{ old('jenis_surat') == 'Surat Undangan Rapat' ? 'selected' : '' }}>Surat Undangan Rapat
                            </option>
                        </select>
                    </div>
                    ...
                    <div id="section-online-wrapper" style="display:none;">
                        ...
                        <div id="section-online-domisili" class="section-online-detail" style="display:none;">
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Data Pribadi
                            </h4>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat_ktp" id="alamat_ktp" rows="2" class="form-control" placeholder="Alamat lengkap sesuai KTP">{{ old('alamat_ktp') }}</textarea>
                            </div>

                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Alamat Domisili
                            </h4>
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Informasi
                                Lainnya</h4>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="lama_tinggal" id="lama_tinggal" class="form-control"
                                    value="{{ old('lama_tinggal') }}" placeholder="Contoh: 12 untuk 1 tahun"
                                    min="1">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="alasan_domisili" id="alasan_domisili" class="form-select">
                                    ...
                                    <option value="Perizinan Usaha"
                                        {{ old('alasan_domisili') == 'Perizinan Usaha' ? 'selected' : '' }}>Perizinan Usaha
                                    </option>
                                    <option value="Pendidikan"
                                        {{ old('alasan_domisili') == 'Pendidikan' ? 'selected' : '' }}>Pendidikan</option>
                                    <option value="Kesehatan"
                                        {{ old('alasan_domisili') == 'Kesehatan' ? 'selected' : '' }}>
                                        Kesehatan</option>
                                    <option value="Keperluan Administrasi"
                                        {{ old('alasan_domisili') == 'Keperluan Administrasi' ? 'selected' : '' }}>
                                        Keperluan
                                        Administrasi</option>
                                    <option value="Lainnya" {{ old('alasan_domisili') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div id="section-online-usaha" class="section-online-detail" style="display:none;">
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Data Pemilik
                                Usaha</h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_usaha" id="jenis_usaha" class="form-select">
                                    ...
                                    <option value="Warung/Toko"
                                        {{ old('jenis_usaha') == 'Warung/Toko' ? 'selected' : '' }}>
                                        Warung/Toko</option>
                                    <option value="Pertanian/Peternakan"
                                        {{ old('jenis_usaha') == 'Pertanian/Peternakan' ? 'selected' : '' }}>
                                        Pertanian/Peternakan</option>
                                    <option value="Bengkel/Reparasi"
                                        {{ old('jenis_usaha') == 'Bengkel/Reparasi' ? 'selected' : '' }}>Bengkel/Reparasi
                                    </option>
                                    <option value="Jasa/Layanan"
                                        {{ old('jenis_usaha') == 'Jasa/Layanan' ? 'selected' : '' }}>Jasa/Layanan</option>
                                    <option value="Kerajinan/Industri Rumahan"
                                        {{ old('jenis_usaha') == 'Kerajinan/Industri Rumahan' ? 'selected' : '' }}>
                                        Kerajinan/Industri Rumahan</option>
                                    <option value="Perdagangan"
                                        {{ old('jenis_usaha') == 'Perdagangan' ? 'selected' : '' }}>
                                        Perdagangan</option>
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Durasi dan
                                Skala Usaha</h4>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="lama_usaha" id="lama_usaha" class="form-control"
                                    value="{{ old('lama_usaha') }}" placeholder="Contoh: 24 untuk 2 tahun"
                                    min="1">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="jumlah_karyawan" id="jumlah_karyawan" class="form-control"
                                    value="{{ old('jumlah_karyawan') }}" placeholder="Jumlah tenaga kerja"
                                    min="0">
                            </div>
                        ...
                        <div id="section-online-sktm" class="section-online-detail" style="display:none;">
                            ...
                            <small>Lengkapi informasi keluarga Anda untuk verifikasi status ekonomi. Data ini diperlukan
                                untuk pengajuan beasiswa, bantuan sosial, atau keperluan lainnya.</small>

                            {{-- IDENTITAS PEMOHON --}}
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Identitas
                                Pemohon</h4>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat_sktm" id="alamat_sktm" rows="2" class="form-control"
                                    placeholder="Tuliskan alamat lengkap beserta RT/RW">{{ old('alamat_sktm') }}</textarea>
                            </div>

                            {{-- STATUS EKONOMI --}}
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Status Ekonomi
                                Keluarga</h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_pekerjaan" id="status_pekerjaan" class="form-select">
                                    ...
                                    <option value="Tidak Bekerja"
                                        {{ old('status_pekerjaan') == 'Tidak Bekerja' ? 'selected' : '' }}>Tidak Bekerja
                                    </option>
                                    <option value="Petani" {{ old('status_pekerjaan') == 'Petani' ? 'selected' : '' }}>
                                        Petani</option>
                                    <option value="Buruh" {{ old('status_pekerjaan') == 'Buruh' ? 'selected' : '' }}>
                                        Buruh
                                    </option>
                                    <option value="Pedagang"
                                        {{ old('status_pekerjaan') == 'Pedagang' ? 'selected' : '' }}>
                                        Pedagang</option>
                                    <option value="Karyawan Swasta"
                                        {{ old('status_pekerjaan') == 'Karyawan Swasta' ? 'selected' : '' }}>Karyawan
                                        Swasta
                                    </option>
                                    <option value="PNS" {{ old('status_pekerjaan') == 'PNS' ? 'selected' : '' }}>PNS
                                    </option>
                                    <option value="Lainnya" {{ old('status_pekerjaan') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="penghasilan_bulanan" id="penghasilan_bulanan"
                                    class="form-control" value="{{ old('penghasilan_bulanan') }}"
                                    placeholder="Contoh: 1500000" min="0">
                                <small style="color:#888;">Masukkan angka tanpa pemisah (gunakan 0 jika tidak ada
                                    penghasilan)</small>
                            </div>

                            <div class="form-group">
                                <label for="jumlah_anggota_keluarga">Jumlah Anggota Keluarga</label>
                                <input type="number" name="jumlah_anggota_keluarga" id="jumlah_anggota_keluarga"
                                    class="form-control" value="{{ old('jumlah_anggota_keluarga') }}"
                                    placeholder="Jumlah orang yang bergantung" min="1" max="20">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_rumah" id="status_rumah" class="form-select">
                                    ...
                                    <option value="Menumpang" {{ old('status_rumah') == 'Menumpang' ? 'selected' : '' }}>
                                        Menumpang</option>
                                    <option value="Menyewa" {{ old('status_rumah') == 'Menyewa' ? 'selected' : '' }}>
                                        Menyewa
                                    </option>
                                </select>
                            </div>
                            ...
                            {{-- TUJUAN PENGAJUAN --}}
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Tujuan
                                Pengajuan</h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="tujuan_sktm" id="tujuan_sktm" class="form-select">
                                    ...
                                    <option value="Beasiswa Pendidikan"
                                        {{ old('tujuan_sktm') == 'Beasiswa Pendidikan' ? 'selected' : '' }}>Beasiswa
                                        Pendidikan</option>
                                    <option value="Bantuan Kesehatan"
                                        {{ old('tujuan_sktm') == 'Bantuan Kesehatan' ? 'selected' : '' }}>Bantuan Kesehatan
                                    </option>
                                    <option value="Bantuan Sosial"
                                        {{ old('tujuan_sktm') == 'Bantuan Sosial' ? 'selected' : '' }}>Bantuan Sosial
                                    </option>
                                    <option value="Kredit/Pinjaman"
                                        {{ old('tujuan_sktm') == 'Kredit/Pinjaman' ? 'selected' : '' }}>Kredit/Pinjaman
                                    </option>
                                    <option value="Asuransi Kesehatan"
                                        {{ old('tujuan_sktm') == 'Asuransi Kesehatan' ? 'selected' : '' }}>Asuransi
                                        Kesehatan
                                    </option>
                                    <option value="Lainnya" {{ old('tujuan_sktm') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="instansi_sktm" id="instansi_sktm" class="form-control"
                                    value="{{ old('instansi_sktm') }}"
                                    placeholder="Contoh: SMPN 1, Rumah Sakit Umum, BRI, dll.">
                            </div>
                        ...
                        <div id="section-online-ktp" class="section-online-detail" style="display:none;">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" name="nik_ktp" id="nik_ktp" class="form-control"
                                    value="{{ old('nik_ktp') }}" placeholder="16 digit NIK" maxlength="16"
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_kelamin_ktp" id="jenis_kelamin_ktp" class="form-select">
                                    ...
                                    <option value="Laki-laki"
                                        {{ old('jenis_kelamin_ktp') == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="Perempuan"
                                        {{ old('jenis_kelamin_ktp') == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="agama_ktp" id="agama_ktp" class="form-select">
                                    ...
                                    <option value="Islam" {{ old('agama_ktp') == 'Islam' ? 'selected' : '' }}>Islam
                                    </option>
                                    <option value="Kristen" {{ old('agama_ktp') == 'Kristen' ? 'selected' : '' }}>Kristen
                                    </option>
                                    <option value="Katolik" {{ old('agama_ktp') == 'Katolik' ? 'selected' : '' }}>Katolik
                                    </option>
                                    <option value="Hindu" {{ old('agama_ktp') == 'Hindu' ? 'selected' : '' }}>Hindu
                                    </option>
                                    <option value="Buddha" {{ old('agama_ktp') == 'Buddha' ? 'selected' : '' }}>Buddha
                                    </option>
                                    <option value="Konghucu" {{ old('agama_ktp') == 'Konghucu' ? 'selected' : '' }}>
                                        Konghucu
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_perkawinan_ktp" id="status_perkawinan_ktp" class="form-select">
                                    ...
                                    <option value="Belum Kawin"
                                        {{ old('status_perkawinan_ktp') == 'Belum Kawin' ? 'selected' : '' }}>Belum Kawin
                                    </option>
                                    <option value="Kawin"
                                        {{ old('status_perkawinan_ktp') == 'Kawin' ? 'selected' : '' }}>
                                        Kawin</option>
                                    <option value="Cerai Hidup"
                                        {{ old('status_perkawinan_ktp') == 'Cerai Hidup' ? 'selected' : '' }}>Cerai Hidup
                                    </option>
                                    <option value="Cerai Mati"
                                        {{ old('status_perkawinan_ktp') == 'Cerai Mati' ? 'selected' : '' }}>Cerai Mati
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Jenis
                                Permohonan</h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_permohonan" id="jenis_permohonan" class="form-select">
                                    ...
                                    <option value="Baru" {{ old('jenis_permohonan') == 'Baru' ? 'selected' : '' }}>KTP
                                        Baru (belum pernah punya)</option>
                                    <option value="Perubahan Data"
                                        {{ old('jenis_permohonan') == 'Perubahan Data' ? 'selected' : '' }}>Perubahan Data
                                        (nama/status/pekerjaan)</option>
                                    <option value="Hilang" {{ old('jenis_permohonan') == 'Hilang' ? 'selected' : '' }}>KTP
                                        Hilang</option>
                                    <option value="Rusak" {{ old('jenis_permohonan') == 'Rusak' ? 'selected' : '' }}>KTP
                                        Rusak</option>
                                    <option value="Perpanjangan"
                                        {{ old('jenis_permohonan') == 'Perpanjangan' ? 'selected' : '' }}>Perpanjangan KTP
                                    </option>
                                </select>
                            </div>

                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Keterangan
                                Permohonan</h4>
                        ...
                        <div id="section-online-kelahiran" class="section-online-detail" style="display:none;">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_kelamin_bayi" id="jenis_kelamin_bayi" class="form-select">
                                    <option value="">-- Pilih --</option>
                                    <option value="Laki-laki"
                                        {{ old('jenis_kelamin_bayi') == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="Perempuan"
                                        {{ old('jenis_kelamin_bayi') == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="tempat_lahir_bayi">Tempat Lahir</label>
                                <input type="text" name="tempat_lahir_bayi" id="tempat_lahir_bayi"
                                    class="form-control" value="{{ old('tempat_lahir_bayi') }}"
                                    placeholder="Contoh: Rumah, Puskesmas, Rumah Sakit">
                            </div>
                            <div class="form-group">
                                <label for="tanggal_lahir_bayi">Tanggal Lahir</label>
                                <input type="date" name="tanggal_lahir_bayi" id="tanggal_lahir_bayi"
                                    class="form-control date-input" value="{{ old('tanggal_lahir_bayi') }}">
                            </div>
                            <div class="form-group">
                                <label for="berat_bayi">Berat Bayi (gram)</label>
                                <input type="number" name="berat_bayi" id="berat_bayi" class="form-control"
                                    value="{{ old('berat_bayi') }}" placeholder="Contoh: 3500" min="500"
                                    max="5000">
                            </div>
                            <div class="form-group">
                                <label for="panjang_bayi">Panjang Bayi (cm)</label>
                                <input type="number" name="panjang_bayi" id="panjang_bayi" class="form-control"
                                    step="0.1" value="{{ old('panjang_bayi') }}" placeholder="Contoh: 50"
                                    min="30" max="60">
                            </div>

                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Data Orang Tua
                            </h4>
                            ...
                            <div class="form-group">
                                <label for="lampiran_kelahiran">Lampiran Dokumen Pendukung <span
                                        style="color:red;">*</span></label>
                                <input type="file" name="lampiran_kelahiran" id="lampiran_kelahiran"
                                    class="form-control" required>
                                <small style="color:#888;">Upload dokumen pendukung (surat bersalin, buku kesehatan
                                    ibu-anak, dll.). Format: PDF, JPG, PNG. Max: 5MB</small>
                            </div>
                        </div>
                        ...
                        <div id="section-online-kematian" class="section-online-detail" style="display:none;">
                            ...
                            <small>Data untuk pembuatan surat keterangan kematian yang akan didaftarkan di Dinas
                                Kependudukan.</small>

                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Data
                                Almarhum/Almarhumah</h4>
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Data Kematian
                            </h4>

                            <div class="form-group">
                                <label for="tanggal_meninggal">Tanggal Meninggal</label>
                                <input type="date" name="tanggal_meninggal" id="tanggal_meninggal"
                                    class="form-control date-input" value="{{ old('tanggal_meninggal') }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="tempat_meninggal" id="tempat_meninggal" class="form-select">
                                    ...
                                    <option value="Rumah" {{ old('tempat_meninggal') == 'Rumah' ? 'selected' : '' }}>
                                        Rumah
                                    </option>
                                    <option value="Rumah Sakit"
                                        {{ old('tempat_meninggal') == 'Rumah Sakit' ? 'selected' : '' }}>Rumah Sakit
                                    </option>
                                    <option value="Puskesmas"
                                        {{ old('tempat_meninggal') == 'Puskesmas' ? 'selected' : '' }}>Puskesmas</option>
                                    <option value="Jalan/Tempat Umum"
                                        {{ old('tempat_meninggal') == 'Jalan/Tempat Umum' ? 'selected' : '' }}>
                                        Jalan/Tempat
                                        Umum</option>
                                    <option value="Lainnya" {{ old('tempat_meninggal') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Data Pemohon
                            </h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="hubungan_pemohon" id="hubungan_pemohon" class="form-select">
                                    ...
                                    <option value="Anak" {{ old('hubungan_pemohon') == 'Anak' ? 'selected' : '' }}>Anak
                                    </option>
                                    <option value="Istri" {{ old('hubungan_pemohon') == 'Istri' ? 'selected' : '' }}>
                                        Istri
                                    </option>
                                    <option value="Suami" {{ old('hubungan_pemohon') == 'Suami' ? 'selected' : '' }}>
                                        Suami
                                    </option>
                                    <option value="Orang Tua"
                                        {{ old('hubungan_pemohon') == 'Orang Tua' ? 'selected' : '' }}>Orang Tua</option>
                                    <option value="Saudara" {{ old('hubungan_pemohon') == 'Saudara' ? 'selected' : '' }}>
                                        Saudara</option>
                                    <option value="Lainnya" {{ old('hubungan_pemohon') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div id="section-online-kua" class="section-online-detail" style="display:none;">
                            ...
                            <small>Lengkapi data calon pengantin dan rencana pernikahan untuk proses di Kantor Urusan
                                Agama.</small>

                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Data Calon
                                Suami</h4>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat_lahir_suami" id="tempat_lahir_suami"
                                    class="form-control" value="{{ old('tempat_lahir_suami') }}"
                                    placeholder="Contoh: Jakarta, 15-01-1995">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat_lahir_istri" id="tempat_lahir_istri"
                                    class="form-control" value="{{ old('tempat_lahir_istri') }}"
                                    placeholder="Contoh: Bandung, 10-05-1997">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pekerjaan_istri" id="pekerjaan_istri" class="form-control"
                                    value="{{ old('pekerjaan_istri') }}"
                                    placeholder="Contoh: Ibu Rumah Tangga, Guru, dll.">
                            </div>

                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Rencana
                                Pernikahan</h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="tempat_nikah" id="tempat_nikah" class="form-select">
                                    <option value="">-- Pilih Tempat --</option>
                                    <option value="KUA" {{ old('tempat_nikah') == 'KUA' ? 'selected' : '' }}>Kantor
                                        Urusan Agama (KUA)</option>
                                    <option value="Rumah" {{ old('tempat_nikah') == 'Rumah' ? 'selected' : '' }}>Rumah
                                    </option>
                                    <option value="Masjid" {{ old('tempat_nikah') == 'Masjid' ? 'selected' : '' }}>Masjid
                                    </option>
                                    <option value="Gedung" {{ old('tempat_nikah') == 'Gedung' ? 'selected' : '' }}>
                                        Gedung/Aula</option>
                                    <option value="Lainnya" {{ old('tempat_nikah') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div id="section-online-belum-menikah" class="section-online-detail" style="display:none;">
                            ...
                            <small>Digunakan untuk keperluan pekerjaan, kuliah, atau keperluan resmi lainnya yang
                                membutuhkan bukti status belum menikah.</small>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" name="nik_belum_menikah" id="nik_belum_menikah"
                                    class="form-control" value="{{ old('nik_belum_menikah') }}"
                                    placeholder="16 digit NIK" maxlength="16" inputmode="numeric">
                            </div>
                            <div class="form-group">
                                <label for="nama_belum_menikah">Nama Lengkap</label>
                                <input type="text" name="nama_belum_menikah" id="nama_belum_menikah"
                                    class="form-control" value="{{ old('nama_belum_menikah') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="tujuan_belum_menikah" id="tujuan_belum_menikah" class="form-select">
                                    ...
                                    <option value="Melamar Pekerjaan"
                                        {{ old('tujuan_belum_menikah') == 'Melamar Pekerjaan' ? 'selected' : '' }}>Melamar
                                        Pekerjaan</option>
                                    <option value="Pendidikan/Kuliah"
                                        {{ old('tujuan_belum_menikah') == 'Pendidikan/Kuliah' ? 'selected' : '' }}>
                                        Pendidikan/Kuliah</option>
                                    <option value="Izin Visa"
                                        {{ old('tujuan_belum_menikah') == 'Izin Visa' ? 'selected' : '' }}>Izin Visa
                                    </option>
                                    <option value="Permohonan Kredit"
                                        {{ old('tujuan_belum_menikah') == 'Permohonan Kredit' ? 'selected' : '' }}>
                                        Permohonan Kredit</option>
                                    <option value="Lainnya"
                                        {{ old('tujuan_belum_menikah') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="instansi_belum_menikah">Nama Instansi/Lembaga Tujuan</label>
                                <input type="text" name="instansi_belum_menikah" id="instansi_belum_menikah"
                                    class="form-control" value="{{ old('instansi_belum_menikah') }}"
                                    placeholder="Contoh: PT Maju Jaya, STIS Jakarta, dll.">
                            </div>
                        </div>
                        ...
                        <div id="section-online-tanah" class="section-online-detail" style="display:none;">
                            ...
                            <small>Data ini akan digunakan untuk keterangan kepemilikan dan kondisi tanah (perlu data akurat
                                untuk verifikasi).</small>

                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Data Tanah
                            </h4>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="luas_tanah" id="luas_tanah" class="form-control"
                                    value="{{ old('luas_tanah') }}" placeholder="Contoh: 200" step="0.01"
                                    min="1">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="peruntukan" id="peruntukan" class="form-select">
                                    ...
                                    <option value="Sawah" {{ old('peruntukan') == 'Sawah' ? 'selected' : '' }}>Sawah
                                    </option>
                                    <option value="Tegalan/Kebun"
                                        {{ old('peruntukan') == 'Tegalan/Kebun' ? 'selected' : '' }}>Tegalan/Kebun
                                    </option>
                                    <option value="Pekarangan/Rumah"
                                        {{ old('peruntukan') == 'Pekarangan/Rumah' ? 'selected' : '' }}>Pekarangan/Rumah
                                    </option>
                                    <option value="Kolam/Tambak"
                                        {{ old('peruntukan') == 'Kolam/Tambak' ? 'selected' : '' }}>Kolam/Tambak</option>
                                    <option value="Usaha/Komersial"
                                        {{ old('peruntukan') == 'Usaha/Komersial' ? 'selected' : '' }}>Usaha/Komersial
                                    </option>
                                    <option value="Lainnya" {{ old('peruntukan') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya
                                    </option>
                                </select>
                            </div>
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Status
                                Kepemilikan</h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_tanah" id="status_tanah" class="form-select">
                                    <option value="">-- Pilih Status --</option>
                                    <option value="Milik Sendiri"
                                        {{ old('status_tanah') == 'Milik Sendiri' ? 'selected' : '' }}>Milik Sendiri
                                    </option>
                                    <option value="Warisan" {{ old('status_tanah') == 'Warisan' ? 'selected' : '' }}>
                                        Warisan</option>
                                    <option value="Hibah" {{ old('status_tanah') == 'Hibah' ? 'selected' : '' }}>Hibah
                                    </option>
                                    <option value="Sewa" {{ old('status_tanah') == 'Sewa' ? 'selected' : '' }}>Sewa
                                    </option>
                                    <option value="Lainnya" {{ old('status_tanah') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div id="section-online-rapat" class="section-online-detail" style="display:none;">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <select name="tipe_rapat" id="tipe_rapat" class="form-select">
                                    ...
                                    <option value="Musyawarah Desa"
                                        {{ old('tipe_rapat') == 'Musyawarah Desa' ? 'selected' : '' }}>Musyawarah Desa
                                    </option>
                                    <option value="Rapat Koordinasi"
                                        {{ old('tipe_rapat') == 'Rapat Koordinasi' ? 'selected' : '' }}>Rapat Koordinasi
                                    </option>
                                    <option value="Rapat Pembangunan"
                                        {{ old('tipe_rapat') == 'Rapat Pembangunan' ? 'selected' : '' }}>Rapat Pembangunan
                                    </option>
                                    <option value="Rapat Evaluasi"
                                        {{ old('tipe_rapat') == 'Rapat Evaluasi' ? 'selected' : '' }}>Rapat Evaluasi
                                    </option>
                                    <option value="Rapat Kerja"
                                        {{ old('tipe_rapat') == 'Rapat Kerja' ? 'selected' : '' }}>
                                        Rapat Kerja</option>
                                    <option value="Pertemuan Umum"
                                        {{ old('tipe_rapat') == 'Pertemuan Umum' ? 'selected' : '' }}>Pertemuan Umum
                                    </option>
                                    <option value="Lainnya" {{ old('tipe_rapat') == 'Lainnya' ? 'selected' : '' }}>
                                        Lainnya
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="judul_rapat" id="judul_rapat" class="form-control"
                                    ...
                                    placeholder="Contoh: Rapat Musyawarah Pembangunan Desa Tahun 2025">
                            </div>
                            <div class="form-group">
                            ...
                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Jadwal dan
                                Tempat</h4>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat_rapat" id="tempat_rapat" class="form-control"
                                    ...
                                    placeholder="Contoh: Balai Desa, Aula Desa, Rumah Kepala Desa, dll.">
                            </div>

                            <h4 style="margin-top:15px; margin-bottom:10px; color:#1b5e20; font-weight:600;">Peserta dan
                                Penanggung Jawab</h4>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="penanggung_jawab" id="penanggung_jawab" class="form-control"
                                    ...
                                    placeholder="Contoh: Kepala Desa, Ketua Panitia, dll.">
                            </div>
                            <div class="form-group">
            ...
            <div class="card">
                ...
                <p class="text-muted">
                    ...
                    • Silakan datang ke kantor desa untuk mengambil dokumen ketika status sudah
                    ...
                    <tbody>
                        @forelse ($surat as $index => $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($status === 'disetujui')
                                        <a href="{{ route('surat.cetak', $item->id) }}" target="_blank" class="btn-cetak">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showHideSections() {
                ...
                sections.forEach(s => {
                    ...
                    s.querySelectorAll('input, select, textarea').forEach(input => {
                        input.disabled = true;
                    });
                });

                if (selectedValue) {
                    // Show wrapper if a selection is made
